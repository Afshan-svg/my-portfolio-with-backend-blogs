...
import { Award, Briefcase, Download, Headphones, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              Full-Stack Engineer @ SJ Innovation specializing in MERN Stack, AI-ML development.
              1.5+ years of experience building production-ready applications.
              Passionate about AI/ML, DevOps, and Flutter.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              {/* Download CV Button */}
              <a
                href="/bruhhhhhhhhh.pdf"
                download="Afshan_Khan_CV.pdf"
              >
                <Button
                  size="lg"
                  className="bg-foreground text-background hover:bg-foreground/90 rounded-full px-8 flex items-center"
                >
                  Download CV
              ...
              <Button
                size="lg"
                variant="outline"
                className=" bg-foreground text-background rounded-full px-8 flex items-center group hover:bg-foreground/90"
